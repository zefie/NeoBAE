...
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeOpen(JNIEnv* env, jobject obj, jstring path) {
...
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeClose(JNIEnv* env, jobject obj, jlong db_ptr) {
    if (db_ptr == 0) return;
...
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeExecute(JNIEnv* env, jobject obj, jlong db_ptr, jstring sql) {
...
JNIEXPORT jboolean JNICALL
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeBatchInsert(
...
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeQuery(
...
Java_com_zefie_NeoBAEDroid_database_SQLiteHelper_nativeGetCount(
    JNIEnv* env, jobject obj, jlong db_ptr, jstring sql) {
